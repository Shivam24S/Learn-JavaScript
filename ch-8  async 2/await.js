...
const promiseVal = new Promise(function (resolve) {
  setTimeout(() => {
    resolve("it's resolve function it appered after 5 seconds");
  }, 5000);
});
...
async function asyncFunction() {
  ...
  console.log("it appered after async function result");
}

asyncFunction();

// as you can see in this example  second console.log() can print result immediatealy but it will not because we have used await() here
